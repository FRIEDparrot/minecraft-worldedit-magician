...
object AgentStepPlanningPrompt {
    ...
    fun instructions(mode: AgentOperationMode): String = buildString {
        if (mode == AgentOperationMode.SINGLE) {
            ...
            appendLine("- Use the returned palette, height bands, block entities, unloaded chunks, and truncation flag to decide the next step. Do not invent missing observations.")
