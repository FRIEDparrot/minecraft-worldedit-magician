 ...
 *
 * Format (fixed): `@s <x>,<y>,<z>|<dim>(<cx>,<cz>) | <player request>`
 *
 * Example: `@s 0,64,0|over(0,0) | build a 5x5 stone platform`
 *
 * Total cost is roughly 12-15 tokens versus the ~100 token long
...
object PlayerStateShortEncoder {
     ...
     */
    @JvmField
    val PLACEHOLDER = "@s 0,64,0|over(0,0)"
    ...
    fun encodeCurrent(): String {
        ...
        return "@s ${pos.x},${pos.y},${pos.z}|$dim(${chunk.x},${chunk.z})"
    }
